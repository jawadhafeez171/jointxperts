    ...
    <section className="relative min-h-screen hero-bg flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-28 pb-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Left content */}
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-[#3aad6e] text-sm font-medium mb-6">
            ...
            <div className="flex flex-wrap gap-3 text-xs text-white/50 mb-10 font-mono">
              ...
              <span className="px-3 py-1 rounded-full border border-white/10 bg-white/5">FRGUHS(Arthroplasty)</span>
            </div>
          ...
          <div className="relative hidden lg:flex justify-center items-center">
            ...
            <div className="relative w-80 h-80">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-7xl font-bold text-white leading-none">15+</div>
            ...
            {/* Floating stat cards */}
            <div className="absolute -left-8 top-8 glass-card rounded-2xl px-5 py-4 float-animation">
              <div className="text-2xl font-bold text-white">5000+</div>
              <div className="text-white/60 text-xs mt-0.5">Happy Patients</div>
            </div>
            <div className="absolute -right-4 bottom-12 glass-card rounded-2xl px-5 py-4 float-animation" style={{ animationDelay: "1.5s" }}>
              <div className="text-2xl font-bold text-[#3aad6e]">98%</div>
              <div className="text-white/60 text-xs mt-0.5">Success Rate</div>
            </div>
            <div className="absolute right-8 -top-4 glass-card rounded-2xl px-5 py-4 float-animation" style={{ animationDelay: "0.8s" }}>
        ...
        {/* Bottom stats bar */}
        <div className="mt-20 grid grid-cols-3 gap-8 pt-10 border-t border-white/10">
