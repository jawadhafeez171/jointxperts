      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-28 pb-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            {/* Premium Google Reviews Trust Badge */}
            <motion.div
              variants={fadeUp}
              initial="hidden"
              animate="visible"
            ...
            >
              <a
                ...
                className="inline-flex items-center gap-3.5 p-2 pr-5 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all group backdrop-blur-md"
              >
                <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-inner flex-shrink-0">
                ...
                <div>
                  <div className="flex items-center gap-1.5">
                    ...
                    <div className="flex gap-0.5">
                      {[...Array(5)].map((_, i) => (
                        <svg key={i} viewBox="0 0 20 20" fill="currentColor" className="w-3.5 h-3.5 text-[#fbbc04]">
                          <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                        </svg>
                      ))}
                    </div>
                  </div>
                  <div className="text-white/70 text-xs mt-1 font-medium group-hover:text-white transition-colors">
          ...
          >
            <div className="relative w-full max-w-lg aspect-square mt-10 group">
              ...
              <motion.div
                ...
                animate="visible"
                custom={0.72}
                className="absolute right-0 -top-8 bg-white rounded-2xl p-4 float-animation z-20 shadow-[0_20px_50px_rgba(0,0,0,0.3)] group cursor-pointer border-2 border-white/40"
                style={{ animationDelay: "0.8s" }}
              >
                <a href="https://maps.app.goo.gl/dzvjfqa8Y3TXfJEK9" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-1">
                      <span className="text-[#0a1e3f] font-bold text-lg leading-none">5.0</span>
                      <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4 text-[#fbbc04]">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                      </svg>
                    </div>
                    <div className="text-gray-500 text-xs mt-0.5 group-hover:text-[#2e8b57] font-medium transition-colors">
                      Google Rating
                    </div>
                  </div>
                </a>
